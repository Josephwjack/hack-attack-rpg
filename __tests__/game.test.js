import { hackerState, coffee, vpn, newName, fullStackCourse} from "../src/game.js";
...
describe ("Hacker", () => {
  ...
  test("fullStackCourse should increase int by 4", () => {
    let hacker = {stealth: 0, health: 0, int: 0, focus: 0, name: ""};
    expect(fullStackCourse(hacker)).toEqual({stealth: 0, health: 0, int: 4, focus: 0, name: ""});
  });
